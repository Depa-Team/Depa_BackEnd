...
namespace Hostlify.Infraestructure.Migrations
{
    ...
    [Migration("20230321001745_EditHistoryTable")]
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.FoodServices", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2023, 3, 20, 19, 17, 45, 654, DateTimeKind.Local).AddTicks(7770));
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.History", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 19, 17, 45, 654, DateTimeKind.Local).AddTicks(4983));
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.Models.Flat", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 19, 17, 45, 654, DateTimeKind.Local).AddTicks(2304));
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.Plan", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 19, 17, 45, 653, DateTimeKind.Local).AddTicks(1536));
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.Room", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 19, 17, 45, 653, DateTimeKind.Local).AddTicks(9825));
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 19, 17, 45, 653, DateTimeKind.Local).AddTicks(4483));
