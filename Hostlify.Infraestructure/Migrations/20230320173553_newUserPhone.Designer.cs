...
namespace Hostlify.Infraestructure.Migrations
{
    ...
    [Migration("20230320173553_newUserPhone")]
    partial class newUserPhone
    {
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.FoodServices", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2023, 3, 20, 12, 35, 53, 572, DateTimeKind.Local).AddTicks(9769));
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.History", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 12, 35, 53, 572, DateTimeKind.Local).AddTicks(8874));
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.Plan", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 12, 35, 53, 572, DateTimeKind.Local).AddTicks(5282));
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.Room", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 12, 35, 53, 572, DateTimeKind.Local).AddTicks(8069));
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 12, 35, 53, 572, DateTimeKind.Local).AddTicks(6348));
