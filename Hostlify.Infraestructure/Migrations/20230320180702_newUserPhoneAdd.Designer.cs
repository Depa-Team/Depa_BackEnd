...
namespace Hostlify.Infraestructure.Migrations
{
    ...
    [Migration("20230320180702_newUserPhoneAdd")]
    partial class newUserPhoneAdd
    {
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.FoodServices", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2023, 3, 20, 13, 7, 2, 268, DateTimeKind.Local).AddTicks(4498));
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.History", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 13, 7, 2, 268, DateTimeKind.Local).AddTicks(3586));
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.Plan", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 13, 7, 2, 267, DateTimeKind.Local).AddTicks(9929));
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.Room", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 13, 7, 2, 268, DateTimeKind.Local).AddTicks(2748));
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 13, 7, 2, 268, DateTimeKind.Local).AddTicks(1227));
