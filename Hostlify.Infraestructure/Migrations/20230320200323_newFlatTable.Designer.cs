...
namespace Hostlify.Infraestructure.Migrations
{
    ...
    [Migration("20230320200323_newFlatTable")]
    partial class newFlatTable
    {
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.FoodServices", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2023, 3, 20, 15, 3, 23, 391, DateTimeKind.Local).AddTicks(5841));
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.History", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 15, 3, 23, 391, DateTimeKind.Local).AddTicks(4920));
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.Models.Flat", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 15, 3, 23, 391, DateTimeKind.Local).AddTicks(4124));
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.Plan", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 15, 3, 23, 391, DateTimeKind.Local).AddTicks(508));
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.Room", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 15, 3, 23, 391, DateTimeKind.Local).AddTicks(3218));
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 15, 3, 23, 391, DateTimeKind.Local).AddTicks(1539));
